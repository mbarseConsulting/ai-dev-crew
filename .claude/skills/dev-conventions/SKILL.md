...
description: "Use when: (1) writing a commit message or naming a branch, (2) bumping a version or writing a changelog entry, (3) deciding whether new code needs tests before it's considered done."
---
...
- Do NOT apply this skill to prose, documentation-only repos with no versioning, or throwaway prototyping explicitly flagged as such by the user
