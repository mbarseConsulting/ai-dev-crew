...
description: "Use when: (1) reviewing code or config that handles authentication, authorization, or user input, (2) auditing dependencies for known vulnerabilities, (3) checking whether a secret or credential ended up committed to the repo."
---
