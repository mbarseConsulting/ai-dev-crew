...
<!-- Customization hook — noms des couches, découpage en packages, mapper retenu  : le fichier projet, jamais ici -->
...
> découpage en packages et le mapper retenu vont dans le **fichier projet**, jamais ici.
>
