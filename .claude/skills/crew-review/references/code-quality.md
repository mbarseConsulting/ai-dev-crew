...
- Do NOT apply this skill to security-only questions (auth, secrets, injection — see `security-review`) or architecture-only questions (system design tradeoffs — see an architecture decision record)
