...
- Do NOT apply this skill to Angular-side code (`angular-craft`), to the shape of the contract itself (`api-rest-craft`), or to layer boundaries inside a backend (`layering-craft`)
