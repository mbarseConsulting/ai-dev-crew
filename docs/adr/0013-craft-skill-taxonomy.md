...
- The `angular-craft` / `test-craft` duplication is now a recorded violation to repair: `test-craft` owns the tier principle, `angular-craft` keeps only its Angular expression.
