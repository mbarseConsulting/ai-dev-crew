# api-rest-craft — fonds universel
...
>
> Ce qui traverse quelle couche est dans `layering-craft`. Les contrats d'événements sont
> dans `kafka-craft`, ceux de socket dans `ws-craft`.
...
lien avec `layering-craft` est direct : si le controller retourne l'entité, le contrat est
