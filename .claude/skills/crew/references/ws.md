...
<!-- Customization hook — forme exacte de l'enveloppe, stratégie d'auth de handshake, intervalle de heartbeat  : le fichier projet, jamais ici -->
...
> de heartbeat retenus vont dans le **fichier projet**, jamais ici.
>
